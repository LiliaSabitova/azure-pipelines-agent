    ...
    public sealed class TaskRunner : AgentService, ITaskRunner
    {
        ...
        private void PublishTelemetry(Definition taskDefinition, HandlerData handlerData)
        {
            ...
            Dictionary<string, string> telemetryData = new Dictionary<string, string>
            {
                ...
                { "OS", (PlatformUtil.GetSystemId() != null) ? PlatformUtil.GetSystemId() : "" },
                { "OSVersion", (systemVersion?.Name != null) ? systemVersion.Name.ToString() : "" },
                { "OSBuild", (systemVersion?.Version != null) ? systemVersion.Version.ToString() : "" },
